% Training a Fine KNN model that was exported from Classidication Learner 
...
for speaker = 1:Classes
    ...
    %% Make Prediction     
    yfit = FineKNN.predictFcn(testData_x);
...
xlabel("Speakers");
ylabel("Accuracy %");
saveas(gcf, 'Fine_KNN/Accuracies.png')
...
% Elapsed time is 7.854512 seconds.